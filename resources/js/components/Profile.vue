	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-12  mt-3">
              ...
              <div class="widget-user-header text-white" style="background-image:url('./img/cover-photo.jpg');">
                  ...
                  <div class="tab-pane active show" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-12">
                          <input v-model="form.name" type="" class="form-control" id="inputName" placeholder="Name" :class="{ 'is-invalid': form.errors.has('name') }">
